...
export const CarouselItem = styled.div<{ index?: number; active?: any }>`
  background: #0f1624;
  border-radius: 3px;
  max-width: 196px;
...
export const CarouselButton = styled.button<{ index?: number; active?: any }>`
  ...
  cursor: pointer;
  margin-right: 4px;
  opacity: ${(props: any): any => (props.active === props.index ? `1` : `.33`)};
